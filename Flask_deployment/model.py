...
df = pd.read_csv(r"C:\Users\nikki\OneDrive\Desktop\NLP\Flask_deployment\cleandata.csv")
...
pickle.dump(classifier, open('LogisticRegression.pkl','wb'))


#saving transformation matrix
with open('matrix.pkl', 'wb') as f: pickle.dump(emails_bow, f)
